...
const int maraca[4] = {10,159,48,0};
const int diabolo[4] = {240,179,52,0};
/* Output */
...
void setup() {
    ...
    Serial.println("Ghost House - Cabinet02 2016/07/24 iLYuSha Wakaka KocmocA");
}
...
{ 
  ...
  else if(mfrc522.uid.uidByte[0] == diabolo[0] && mfrc522.uid.uidByte[1] == diabolo[1] && mfrc522.uid.uidByte[2] == diabolo[2] && mfrc522.uid.uidByte[3] == diabolo[3])
