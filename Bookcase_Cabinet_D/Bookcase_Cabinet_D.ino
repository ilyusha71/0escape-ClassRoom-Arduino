...
const int tagMaraca[4] = {225,162,52,0};
const int tagDoll[4] = {155,90,51,0};
/* Output */
...
void setup() 
{
    ...
    Serial.println("Bookcase - Cabinet D 2016/09/15 iLYuSha Wakaka KocmocA");
}
...
{ 
  if(escape == -1)
  {
    ...
    else if(mfrc522.uid.uidByte[0] == tagDoll[0] && mfrc522.uid.uidByte[1] == tagDoll[1] && mfrc522.uid.uidByte[2] == tagDoll[2] && mfrc522.uid.uidByte[3] == tagDoll[3])
    {
      digitalWrite(passDoll, LOW);
      Serial.print("Doll Bingo ");
      ShowTagID();
      Serial.println("");
    }
  }
