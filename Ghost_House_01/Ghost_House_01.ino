...
const int poker[4] = {133,129,52,0};
const int car[4] = {16,19,44,51};
/* Output */
...
void setup() {
    ...
    pinMode(passCar,OUTPUT);
    digitalWrite(passPoker, LOW);
    digitalWrite(passCar, HIGH);
    Serial.println("Ghost House - Cabinet01 2016/07/24 iLYuSha Wakaka KocmocA");
}
...
{ 
  ...
  else if(mfrc522.uid.uidByte[0] == car[0] && mfrc522.uid.uidByte[1] == car[1] && mfrc522.uid.uidByte[2] == car[2] && mfrc522.uid.uidByte[3] == car[3])
    digitalWrite(passCar, LOW);
